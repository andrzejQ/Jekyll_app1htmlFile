...
Można próbować te różne wersje w różnych przeglądarkach (nie zawsze działają skutecznie).
		* Uwagi:
			...
			* `ovCp1` - jeśli działa to jest wygodna w użyciu, ale raczej nie działa na zablokowanych stronach
