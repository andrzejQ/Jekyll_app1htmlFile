//Extract ['img','o365','name','title','location','role'] list in MS Teams
(function() {
var x = document.querySelector("div[class^='td-members-']");   //.getElementsByClassName("td-members-tab team-dashboard-tab flex-fill");
var t = x.innerHTML;
var re =/<div class="td\-member\-name.*?(<img .+?" upn="(.*?)".+?>)[\s\S]+?\<div class="td-member-display-name"><span .*?>(.*?)<\/span>.+?"::teamMember.jobTitle" aria-label=(?:"undefined|")(.*?)[\,"](?:.*?::teamMember.userLocation" aria-label=(?:"undefined|")(.*?)[\,"])?.+?\-member\-role.+?<span .+?>(.*)<\/span>(?:<\/div>)?<!----><!---->/g;
